 ...
 * @category export
 *
 * @author Osonich - sierra-group.in.ua
 * @copyright Osonich / PrestaShop 1.7.4.1
...
class AdminExportProductsController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->available_fields = array(
            ...
            'wholesale_price' => array('label' => 'Wholesale price ?? Cost price'),
            ...
            'manufacturer' => array('label' => 'Brand'),
            ...
            'delivery_out_stock' => array('label' => 'Delivery time of out-of-stock products with allowed'),
            ...
            'low_stock_alert' => array('label' => 'Send me an email when the quantity is below or equals'),
            'visibility' => array('label' => 'Visibility'),
            'additional_shipping_cost' => array('label' => 'Additional shipping cost'),
            'unity' => array('label' => 'Base price'),
            'unit_price' => array('label' => 'Summary !!!!'),
            ...
            'available_now' => array('label' => 'Label when in stock'),
            'available_later' => array('label' => 'Label when out of stock and back order allowed'),
            'available_for_order' => array('label' => 'Available for YYYY-MM-DD'),
            'available_date' => array('label' => 'Product avaible date'),
            'date_add' => array('label' => 'Product creation date'),
            'show_price' => array('label' => 'Show price (0 = No, 1 = Yes)'),
            'image' => array('label' => 'Image URLs'),
            'image_alt' => array('label' => 'Image  alt text'),
            ...
            'is_virtual' => array ('label' => 'is vertual'),
            'file_url' => array('label' => 'file url'),
            'nb_downloadable' => array(
                'label' => 'nb_days_accessible',
                'help' => 'Number of days this file can be accessed by customers. Set to zero for unlimited access. ',
            ),
            'date_expiration' => array ('label' => 'Date expiration'),
...
//            fputcsv(
//                $f,
//                array(count($titles), count($this->available_fields)),
//                $delimiter,
//                '"'
//            );
            fputcsv(
            ...
            foreach ($products as $product) {
                ...
                foreach ($this->available_fields as $field => $array) {
                    ...
                    if (!array_key_exists( $field, $line)) { $line[$field] = '0'; }
                }
...
//                fputcsv(
//                    $f,
//                    array(count($line), count($this->available_fields)),
//                    $delimiter,
//                    '"'
//                );
                fputcsv(
