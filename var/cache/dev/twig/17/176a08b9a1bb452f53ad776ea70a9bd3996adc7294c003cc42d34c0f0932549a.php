...
class __TwigTemplate_3424c5ce42a7a507ecb449a7d2020a2209353ac9921cba13356eb0f8bfbe9c4a extends Twig_Template
{
...
($context["js_translatable"] ?? $this->getContext($context, "js_translatable")), "Are you sure to disable variations ? they will all be deleted", array(), "array"))),         // line 348
($context["js_translatable"] ?? $this->getContext($context, "js_translatable")));
        // line 25
...
($context["preview_link"] ?? $this->getContext($context, "preview_link")), "preview_link_deactivate" =>         // line 254
($context["preview_link_deactivate"] ?? $this->getContext($context, "preview_link_deactivate")), "is_shop_context" =>         // line 255
($context["is_shop_context"] ?? $this->getContext($context, "is_shop_context")), "editable" =>         // line 256
($context["editable"] ?? $this->getContext($context, "editable")), "is_active" => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(        // line 257
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "vars", array()), "value", array()), "active", array()), "productId" =>         // line 258
...
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "inputPackItems", array()), "productId" =>         // line 62
($context["id_product"] ?? $this->getContext($context, "id_product")), "images" => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(        // line 63
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "vars", array()), "value", array()), "images", array()), "formShortDescription" => $this->getAttribute($this->getAttribute(        // line 64
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "description_short", array()), "formDescription" => $this->getAttribute($this->getAttribute(        // line 65
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "description", array()), "formFeatures" => $this->getAttribute($this->getAttribute(        // line 66
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "features", array()), "formManufacturer" => $this->getAttribute($this->getAttribute(        // line 67
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "id_manufacturer", array()), "formRelatedProducts" => $this->getAttribute($this->getAttribute(        // line 68
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "related_products", array()), "is_combination_active" =>         // line 69
($context["is_combination_active"] ?? $this->getContext($context, "is_combination_active")), "has_combinations" =>         // line 70
($context["has_combinations"] ?? $this->getContext($context, "has_combinations")), "formReference" => $this->getAttribute($this->getAttribute(        // line 71
($context["form"] ?? $this->getContext($context, "form")), "step6", array()), "reference", array()), "formQuantityShortcut" => $this->getAttribute($this->getAttribute(        // line 72
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "qty_0_shortcut", array()), "formPriceShortcut" => $this->getAttribute($this->getAttribute(        // line 73
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "price_shortcut", array()), "formPriceShortcutTTC" => $this->getAttribute($this->getAttribute(        // line 74
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "price_ttc_shortcut", array()), "formCategories" => $this->getAttribute(        // line 75
...
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "depends_on_stock", array()), "productId" =>         // line 84
($context["id_product"] ?? $this->getContext($context, "id_product")), "formStockQuantity" => $this->getAttribute($this->getAttribute(        // line 85
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "qty_0", array()), "formStockMinimalQuantity" => $this->getAttribute($this->getAttribute(        // line 86
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "minimal_quantity", array()), "formLowStockThreshold" => $this->getAttribute($this->getAttribute(        // line 87
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "low_stock_threshold", array()), "formLowStockAlert" => $this->getAttribute($this->getAttribute(        // line 88
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "low_stock_alert", array()), "formVirtualProduct" => $this->getAttribute($this->getAttribute(        // line 89
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "virtual_product", array()), "asm_globally_activated" =>         // line 90
($context["asm_globally_activated"] ?? $this->getContext($context, "asm_globally_activated")), "formType" => $this->getAttribute($this->getAttribute(        // line 91
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "type_product", array()), "formAdvancedStockManagement" => $this->getAttribute($this->getAttribute(        // line 92
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "advanced_stock_management", array()), "formPackStockType" => $this->getAttribute($this->getAttribute(        // line 93
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "pack_stock_type", array()), "formStep3" => $this->getAttribute(        // line 94
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "formCombinations" =>         // line 95
($context["formCombinations"] ?? $this->getContext($context, "formCombinations")), "has_combinations" =>         // line 96
($context["has_combinations"] ?? $this->getContext($context, "has_combinations")), "max_upload_size" =>         // line 97
...
($context["form"] ?? $this->getContext($context, "form")), "step4", array()), "asm_globally_activated" =>         // line 111
($context["asm_globally_activated"] ?? $this->getContext($context, "asm_globally_activated")), "isNotVirtual" => ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(        // line 112
($context["form"] ?? $this->getContext($context, "form")), "step1", array()), "type_product", array()), "vars", array()), "value", array()) != "2"), "isChecked" => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(        // line 113
($context["form"] ?? $this->getContext($context, "form")), "step3", array()), "advanced_stock_management", array()), "vars", array()), "checked", array()), "warehouses" =>         // line 114
...
($context["form"] ?? $this->getContext($context, "form")), "step2", array()), "is_multishop_context" =>         // line 127
($context["is_multishop_context"] ?? $this->getContext($context, "is_multishop_context")), "productId" =>         // line 128
($context["id_product"] ?? $this->getContext($context, "id_product"))));
        // line 129
        echo "
        ";
...
($context["form"] ?? $this->getContext($context, "form")), "step5", array()), "productId" =>         // line 136
($context["id_product"] ?? $this->getContext($context, "id_product"))));
        // line 137
        echo "
        ";
...
($context["form"] ?? $this->getContext($context, "form")), "step6", array()), "productId" =>         // line 144
($context["id_product"] ?? $this->getContext($context, "id_product"))));
        // line 145
        echo "
        ";
...
", "@PrestaShop/Admin/Product/ProductPage/product.html.twig", "D:\\server\\OSPanel\\domains\\presta\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Product\\ProductPage\\product.html.twig");
    }
}


/* @PrestaShop/Admin/Product/ProductPage/product.html.twig */
class __TwigTemplate_3424c5ce42a7a507ecb449a7d2020a2209353ac9921cba13356eb0f8bfbe9c4a_1566115959 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
